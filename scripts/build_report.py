...
def build() -> None:
    ...
    story = [
        ...
        *screenshot("04-ai-authoring.png", "图 4  智能命题中的逐类型测试点配额"),
        p(
        ...
        *screenshot("06-ai-iteration.png", "图 5  迭代意见与测试点配额同屏配置"),
        p(
        ...
        *screenshot("00-dashboard-admin.png", "图 6  等级、资源统计与角色化功能入口"),
        PageBreak(),
        p("7. AI 使用说明", "H1"),
        p(
