...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        navigation = page.locator("[data-testid=stSidebar] input[type=radio]")
        navigation.nth(0).evaluate("element => element.click()")
        ...
        navigation.nth(3).evaluate("element => element.click()")
        ...
        navigation.nth(4).evaluate("element => element.click()")
        page.wait_for_timeout(1200)
